...
|US24|Atender ticket de transferencia|Como administrador quiero atender los tickets de transferencia para pagar a los propietarios|<p>***Escenario 1:Ticket confirmado***</p><pDado que el administrador está autenticado</p><pCuando está en la pantalla de tickets de retiro de créditos</p><p>Y da clic en el botón “Confirmar” en los tickets necesarios</p><p>Entonces los tickets cambiarán a estado confirmado</p><p>***Escenario 2:Ticket aplazado***</p><pDado que el administrador está autenticado</p><pCuando está en la pantalla de tickets de retiro de créditos</p><p>Y da clic en el botón “Aplazar” en los tickets necesarios</p><p>Entonces los tickets cambiarán a estado aplazado</p>|EP06|
|US25|Salir de una sala|Como jugador quiero salirme de una sala comunidad|<p>***Escenario 1:Eliminación exitosa del usuario de una sala comunidad***</p><pDado que el jugador, se encuentra autenticado</p><pCuando se encuentra en la pantalla de su sala comunidad seleccionada</p><p>Y la diferencia entre la hora actual y la hora de inicio de la sala comunidad es mayor a 24 horas</p><p>Entonces la aplicación muestra un mensaje al jugador indicando que se realizó con éxito la salida de la sala comunidad</p>|EP05|

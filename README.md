...
| Canales de distribución              | D'Taquito está disponible como un servicio accesible a través de navegadores de internet en computadoras de escritorio, laptops y dispositivos móviles con conexión a internet.| Esta aplicación está disponible en la web y también se puede descargar en dispositivos móviles a través de la Play Store y la App Store. Por lo tanto, sus canales de distribución son tanto web como móvil.              | La página web de ¿Donde juego? muestra que su servicio principal es la facilidad de uso, la disponibilidad 24/7, y la capacidad de gestionar todo desde un dispositivo móvil. Por lo tanto, sus canales de distribución son tanto web como móvil.             | Esta plataforma ofrece una serie de productos y servicios a través de su sitio web. Además, parece que también tienen una aplicación móvil, lo que significa que sus canales de distribución son tanto web como móvil.              |
...
| **Frontend**  | EP05    | Gestión de salas comunidad              | Como jugador quiero gestionar la creación de salas comunidad para conocer nuevas personas con quienes jugar | US16, US17, US18, US19, US20, US25                        |
| **Frontend**  | EP06    | Gestión de tickets para transferencia    | Como propietario quiero gestionar mis tickets de transferencia para obtener mis ganancias                     | US21, US22, US24         |
| **Landing Page** | EP07    | Elementos de landing page               | Como visitante quiero visualizar el contenido resaltante del landing page para conocer sobre la aplicación   | US26                                           |
...
|US24|Atender ticket de transferencia|Como administrador quiero atender los tickets de transferencia para pagar a los propietarios|<p>***Escenario 1: Ticket confirmado***</p><p>Dado que el administrador está autenticado</p><p>Cuando está en la pantalla de tickets de retiro de créditos</p><p>Y da clic en el botón “Confirmar” en los tickets necesarios</p><p>Entonces los tickets cambiarán a estado confirmado</p><p>***Escenario 2:Ticket aplazado***</p><p>Dado que el administrador está autenticado</p><p>Cuando está en la pantalla de tickets de retiro de créditos</p><p>Y da clic en el botón “Aplazar” en los tickets necesarios</p><p>Entonces los tickets cambiarán a estado aplazado</p>|EP06|
|US25|Salir de una sala|Como jugador quiero salirme de una sala comunidad|<p>***Escenario 1: Eliminación exitosa del usuario de una sala comunidad***</p><p>Dado que el jugador, se encuentra autenticado</p><p>Cuando se encuentra en la pantalla de su sala comunidad seleccionada</p><p>Y la diferencia entre la hora actual y la hora de inicio de la sala comunidad es mayor a 24 horas</p><p>Entonces la aplicación muestra un mensaje al jugador indicando que se realizó con éxito la salida de la sala comunidad</p>|EP05|
|US26|Conocer acerca de la aplicación|Como visitante del landing page quiero saber acerca de la aplicación para conocer sus detalles|<p>***Escenario 1: Leer acerca de la aplicación***</p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante da clic a los diferentes apartados</p><p>Entonces podrá visualizar la información deseada</p>|EP07|
...
|TS35|Solicitar olvido de contraseña|Como desarrollador, necesito implementar un endpoint POST en el API nombrado "recover-password/forgot-password” para que se solicite un enlace para recuperar contraseña|<p>***Escenario 1: Solicitud de mandado de enlace a email ingresado exitoso***</p><p>Dado que el desarrollador implementa un endpoint para solicitar un enlace para recuperar contraseña</p><p>Cuando solicita la petición con params: email</p><p>Y el usuario tiene un email registrado en la base de datos</p><p>Entonces, es permitido el envío de su recuperación de contraseña a su correo con un code 200.</p>|EP18|
|TS36|Reiniciar contraseña|Como desarrollador, necesito implementar un endpoint POST en el API nombrado "recover-password/reset-password” para que se reinicie contraseña|<p>***Escenario 1: Reinicio exitoso de contraseña***</p><p>Dado que el desarrollador implementa un endpoint para reiniciar la contraseña</p><p>Cuando solicita la petición con body: token y newPassword</p><p>Y el campo newPassword cumple los requisitos de número, uppercase y/o carácter especial</p><p>Entonces, es permitido el reinicio de su contraseña con un code 200.</p>|EP18|
|TS37|Recuperar datos del dispositivo IoT al servidor|Como desarrollador, necesito implementar un endpoint PATCH en el API nombrado "sport-spaces/create-number/{sportSpaceId}/update-amount-people” para que pueda mandar la cantidad de personas ingresadas a un espacio deportivo en un rango de horas|<p>***Escenario 1: Envío exitoso de datos de personas ingresadas al servidor***</p><p>Dado que el desarrollador implementa un endpoint para mandar la cantidad de personas ingresadas a un espacio deportivo en un rango de horas</p><p>Cuando solicita la petición con params: sportSpaceId y amountPeople</p><p>Y el campo sportSpaceId existe</p><p>Entonces, es permitido el envío del número de personas ingresadas en un rango de horas al servidor con un code 200.</p>|EP11|
|TS38|Visualizar datos del dispositivo IoT al servidor|Como desarrollador, necesito implementar un endpoint GET en el API nombrado "sport-spaces/get-number/{sportSpaceId}/amount-people” para que pueda obtener la cantidad de personas ingresadas a un espacio deportivo en un rango de horas|<p>***Escenario 1: Recepción exitoso de datos de personas ingresadas al servidor***</p><p>Dado que el desarrollador implementa un endpoint para obtener la cantidad de personas ingresadas a un espacio deportivo en un rango de horas</p><p>Cuando solicita la petición con params: sportSpaceId, currentMonth y currentYear</p><p>Y el campo sportSpaceId existe</p><p>Entonces, es permitido el envío del número de personas ingresadas en un rango de horas al servidor con un code 200.</p>|EP11|
|TS39|Salir de una sala comunidad|Como desarrollador, necesito implementar un endpoint DELETE en el API nombrado "player-lists/leave/{roomId}” para que pueda solicitar el salirse de una sala comunidad|<p>***Escenario 1: Eliminación exitoso de jugador de una sala comunidad***</p><p>Dado que el desarrollador implementa un endpoint para solicitar el salirse de una sala comunidad</p><p>Cuando solicita la petición con params: roomId</p><p>Y el campo roomId existe</p><p>Y el rango de horas está dentro de las 24 horas antes de iniciar la sala comunidad</p><p>Entonces, es permitido el envío de la solicitud para salirse de una sala comunidad con un code 200.</p>|EP13|
...
|-------|------|--------|-------------|--------------|
| 1 | TS01 | Crear usuario | Como desarrollador necesito implementar el endpoint POST users/sign-up para registrar usuarios en la app | 5 |
| 2 | TS07 | Autenticar usuario | Como desarrollador necesito implementar el endpoint POST authentication/sign-in para autenticar a un usuario | 5 |
| 3 | TS09 | Verificar autenticación | Como desarrollador necesito implementar el endpoint GET authentication/is-authenticated para verificar si estoy autenticado | 2 |
| 4 | TS08 | Desautenticar usuario | Como desarrollador necesito implementar el endpoint POST authentication/log-out para cerrar sesión del usuario | 2 |
| 5 | TS06 | Obtener información del usuario | Como desarrollador necesito implementar el endpoint GET users/me para obtener la información del usuario autenticado | 2 |
| 6 | TS02 | Actualizar nombre | Como desarrollador necesito implementar el endpoint PUT users/name para actualizar el nombre del usuario | 2 |
| 7 | TS03 | Actualizar correo | Como desarrollador necesito implementar el endpoint PUT users/email para actualizar el correo del usuario | 2 |
| 8 | TS04 | Actualizar contraseña | Como desarrollador necesito implementar el endpoint PUT users/password para actualizar la contraseña del usuario | 2 |
| 9 | TS35 | Solicitar olvido de contraseña | Como desarrollador necesito implementar el endpoint POST recover-password/forgot-password para solicitar recuperación | 3 |
| 10 | TS36 | Reiniciar contraseña | Como desarrollador necesito implementar el endpoint POST recover-password/reset-password para reiniciar la contraseña | 3 |
| 11 | TS05 | Obtener todos los usuarios | Como desarrollador necesito implementar el endpoint GET users/all para que un ADMIN obtenga todos los usuarios | 2 |
| 12 | TS10 | Actualizar suscripción | Como desarrollador necesito implementar el endpoint PUT subscriptions/upgrade para actualizar la suscripción de un usuario | 5 |
| 13 | TS11 | Obtener suscripción de un usuario | Como desarrollador necesito implementar el endpoint GET api/v1/subscriptions para ver la suscripción de un usuario | 2 |
| 14 | TS12 | Crear espacio deportivo | Como desarrollador necesito implementar el endpoint POST sport-spaces/create para que un OWNER cree un espacio deportivo | 5 |
| 15 | TS13 | Obtener espacio deportivo por ID | Como desarrollador necesito implementar el endpoint GET sport-spaces/{id} para obtener un espacio deportivo por ID | 2 |
| 16 | TS14 | Obtener espacios propios | Como desarrollador necesito implementar el endpoint GET sport-spaces/my-space para que un OWNER vea sus espacios | 2 |
| 17 | TS15 | Obtener todos los espacios deportivos | Como desarrollador necesito implementar el endpoint GET sport-spaces/all para obtener todos los espacios deportivos | 2 |
| 18 | TS16 | Eliminar un espacio deportivo | Como desarrollador necesito implementar el endpoint DELETE sport-spaces/{id} para eliminar un espacio como OWNER | 5 |
| 19 | TS37 | Recuperar datos del dispositivo IoT al servidor | Como desarrollador, necesito implementar un endpoint PATCH sport-spaces/create-number/{sportSpaceId}/update-amount-people | 5 |
| 20 | TS38 | Visualizar datos del dispositivo IoT al servidor | Como desarrollador, necesito implementar un endpoint GET sport-spaces/get-number/{sportSpaceId}/amount-people | 2 |
| 21 | TS25 | Crear un depósito | Como desarrollador necesito implementar el endpoint POST deposit/create-deposit para que un jugador recargue créditos | 5 |
| 22 | TS17 | Crear una reserva | Como desarrollador necesito implementar el endpoint POST reservations/create para que un usuario PLAYER realice una reserva | 8 |
| 23 | TS18 | Obtener reservas | Como desarrollador necesito implementar el endpoint GET reservations/my-reservations para ver reservas del usuario | 2 |
| 24 | TS19 | Eliminar una reserva | Como desarrollador necesito implementar el endpoint DELETE reservations/{id} para eliminar una reserva como PLAYER | 5 |
| 25 | TS20 | Obtener y verificar un QR | Como desarrollador necesito implementar el endpoint GET reservations/verify-qr-image para obtener el QR de acceso | 5 |
| 26 | TS21 | Usar QR | Como desarrollador necesito implementar el endpoint POST reservations/user-qr-token para que el jugador use su QR | 5 |
| 27 | TS26 | Crear petición para retiro | Como desarrollador necesito implementar el endpoint POST bank-transfer/create para solicitar retiro de créditos como OWNER | 5 |
| 28 | TS28 | Obtener solicitud de retiro de un usuario | Como desarrollador necesito implementar el endpoint GET bank-transfer/user/{userId} para obtener la solicitud de retiro de un usuario | 2 |
| 29 | TS29 | Obtener todas solicitudes de retiro | Como desarrollador necesito implementar el endpoint GET bank-transfer/all para obtener todas las solicitudes de retiro | 2 |
| 30 | TS27 | Atender solicitud de retiro | Como desarrollador necesito implementar el endpoint PATCH bank-transfer/update-transfer/{id} para que un ADMIN atienda la solicitud | 5 |
| 31 | TS40 | Diferir la solicitud de retiro de un usuario OWNER | Como desarrollador necesito implementar un endpoint PATCH bank-transfer/defer/{id} para que se difiera una petición de retiro | 2 |
| 32 | TS22 | Unirse a una sala comunidad | Como desarrollador necesito implementar el endpoint POST player-lists/join para que un usuario se una a una sala COMMUNITY | 5 |
| 33 | TS23 | Obtener lista de jugadores de una sala | Como desarrollador necesito implementar el endpoint GET player-lists/room/{roomId} para ver jugadores de una sala | 3 |
| 34 | TS39 | Salir de una sala comunidad | Como desarrollador necesito implementar un endpoint DELETE player-lists/leave/{roomId} para que pueda solicitar el salirse de una sala comunidad | 5 |
| 35 | TS24 | Enviar mensaje al chat de una sala | Como desarrollador necesito implementar el endpoint POST "chat/rooms/{chatRoomId}/messages" para poder enviar mensajes a un chat específico | 3 |
| 36 | TS30 | Obtener sala por ID | Como desarrollador necesito implementar el endpoint GET rooms/{id} para obtener una sala por su ID | 2 |
| 37 | TS31 | Obtener salas por usuario específico | Como desarrollador necesito implementar el endpoint GET rooms/my-rooms para obtener salas propias | 2 |
| 38 | TS32 | Obtener salas por espacios deportivos | Como desarrollador necesito implementar el endpoint GET rooms/my-rooms-by-spaces para ver salas por espacio | 2 |
| 39 | TS33 | Obtener salas unidas por jugador | Como desarrollador necesito implementar el endpoint GET rooms/my-join-rooms para ver salas unidas | 2 |
| 40 | TS34 | Obtener todas las salas (ADMIN) | Como desarrollador necesito implementar el endpoint GET rooms/all para obtener todas las salas como ADMIN | 2 |
...
<p align="center">
 <img src="https://raw.githubusercontent.com//Tecny/development-of-iot-solutions-final-project/develop//images//landingW1.png" alt="UPC">
</p>
...
- Las user stories y el user persona indican que estamos trabajando en proporcionar un valor real a nuestros usuarios, abordando sus problemas y necesidades. Este enfoque conjunto en la experiencia del usuario es esencial para construir una aplicación que sea relevante y atractiva.

- El product backlog nos proporciona una visión clara de las funcionalidades y características que deseamos incluir en D’Taquito. Nuestra colaboración en la priorización es esencial para garantizar que las características más importantes se desarrollen primero y que todos estemos alineados en nuestros objetivos.

- El análisis "as-is" y "to-be" muestra que estamos pensando en cómo optimizar y mejorar el proceso de reciclaje y reacondicionamiento de dispositivos electrónicos. Nuestra visión compartida es asegurarnos de que D’Taquito proporcione un valor real y tangiblemente mejore la experiencia de los usuarios.
